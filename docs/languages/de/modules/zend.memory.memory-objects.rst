...
Gesperrte Objekte haben das selbe Interface wie verschiebbare Objekte (``Zend\Memory\Container\Interface``).
...
Die Klasse der gelockten Objekte (``Zend\Memory\Container\Locked``) garantiert virtuell die selbe Performance wie
