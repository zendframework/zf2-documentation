...
*Zend_Service* biedt ondersteuning voor eender welke REST-gebaseerde web service via :ref:`Zend_Rest_Client
<zend.rest.client>`.

Naast de mogelijkheid om *Zend_Service* uit te breiden en *Zend_Service_Rest* te gebruiken voor REST-gebaseerde web
