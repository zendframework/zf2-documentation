...
.. table:: Zend Framework'de kullanılan PHP eklentileri
   ...
   +============+=============+==========================================================================================================================================================================================================+
   |apc         |Bağımlı      |Zend\Cache_Backend\Apc                                                                                                                                                                                    |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |com_dotnet  |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |ctype       |Bağımlı      |Zend\Auth_Adapter\Http, ZendGData\App, Zend\Http\Client, ZendPdf, Zend\Rest\Client, Zend\Rest\Server, Zend\Search\Lucene, Zend_Uri, Zend_Validate                                                       |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |dbase       |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |dom         |Bağımlı      |Zend_Feed, ZendGData, Zend\Log_Formatter\Xml, Zend\Rest\Server, Zend\Search\Lucene, Zend\Service\Amazon, Zend\Service\Delicious, Zend\Service\Flickr, Zend\Service\Simpy, Zend\Service\Yahoo, Zend_XmlRpc|
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |exif        |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |fbsql       |--           |                                                                                                                                                                                                          |
   ...
   |hash        |?            |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |ibm_db2     |Bağımlı      |Zend\Db_Adapter\Db2                                                                                                                                                                                       |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |mcrypt      |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |memcache    |Bağımlı      |Zend\Cache_Backend\Memcached                                                                                                                                                                              |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |mhash       |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |mysql       |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |mysqli      |Bağımlı      |Zend\Db_Adapter\Mysqli                                                                                                                                                                                    |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |ncurses     |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |oci8        |Bağımlı      |Zend\Db_Adapter\Oracle                                                                                                                                                                                    |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |odbc        |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |openssl     |--           |                                                                                                                                                                                                          |
   ...
   |wddx        |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |xml         |Bağımlı      |Zend\Translator_Adapter\Qt, Zend\Translator_Adapter\Tmx, Zend\Translator_Adapter\Xliff                                                                                                                    |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |XMLReader   |--           |                                                                                                                                                                                                          |
   +------------+-------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |xmlrpc      |--           |                                                                                                                                                                                                          |
