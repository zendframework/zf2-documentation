...
*Zend\Mail_Transport\Smtp* s hodnotou 'ssl' alebo 'tls'. Takisto je možné nastaviť iný port ako 25 pre TLS,
alebo 465 pre SSL.

.. rubric:: Vytvorene zabezpečného spojenia pomocou Zend\Mail_Transport\Smtp
