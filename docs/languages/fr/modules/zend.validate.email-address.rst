...
La partie domaine d'une adresse émail est validée via :ref:`Zend_Validate_Hostname <zend.validate.set.hostname>`.
...
:ref:`documentation de Zend_Validate_Hostname <zend.validate.set.hostname>`.
