...
``Zend_Navigation`` est fournie par défaut avec deux types de page:
   ...
   - :ref:`Pages MVC <zend.navigation.pages.mvc>` – utilisant la classe ``Zend\Navigation\Page\Mvc``

   - :ref:`Pages URI <zend.navigation.pages.uri>` – utilisant la classe ``Zend\Navigation\Page\Uri``
