...
Есть всего две наиболее часто используемых реализации интерфейса ``TableGatewayInterface``:
...
В объект `TableGateway`` особенности должны внедряться через конструктор. Конструктор может получать особенности
трех разных форм: единственный объект особенности, объект FeatureSet или массив объектов Feature.

Вот базовый набор особенностей, уже рализованных в Zend\\Db:
