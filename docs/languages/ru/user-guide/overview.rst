...
создания простого приложения основанного на базе данных с приминением парадигмы
...
На главной странице будет перечислена на коллекция и доступны функции добавления,
