...
The ``Zend_Markup`` component provides an extensible way for parsing text and rendering lightweight markup
...
``Zend_Markup_Renderer_Abstract``. The factory method accepts three arguments. The first one is the parser used to
