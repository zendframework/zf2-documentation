...
``Zend_Auth_Adapter_Http`` proporciona una implementación compatible con `RFC-2617`_, `Basic`_ y `Digest`_
...
.. table:: Opciones de Configuración
   ...
   +-----------------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   |digest_domains   |Si, cuando accept_schemes contiene 'digest'|Lista de URI s separadas por espacios para las cuales la misma información de autenticación es válida. No es necesario que todas las URI s apunten al mismo oservidor.   |
   +-----------------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
``Zend_Auth_Adapter_Http`` se basa en la implementación de objetos ``Zend_Auth_Adapter_Http_Resolver_Interface``.
