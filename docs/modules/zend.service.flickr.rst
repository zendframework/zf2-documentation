...
The following classes are all returned by ``tagSearch()`` and ``userSearch()`` :
    - Zend_Service_Flickr_ResultSetZend_Service_Flickr_ResultZend_Service_Flickr_Image
...
Zend_Service_Flickr_ResultSet Properties
----------------------------------------
+---------------------+----+-----------------------------------------------------+
...
Zend_Service_Flickr_Result Properties
-------------------------------------
+----------+-------------------------+------------------------------------------------------------------+
|Name      |Type                     |Description                                                       |
+==========+=========================+==================================================================+
...
Zend_Service_Flickr_Image Properties
------------------------------------
+--------+------+--------------------------------------------------+
|Name    |Type  |Description                                       |
+========+======+==================================================+
