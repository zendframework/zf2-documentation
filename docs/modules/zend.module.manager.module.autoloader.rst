...
Keep in mind that in order for paths relative to your application directory to work, you must have the directivechdir(dirname(__DIR__));in your ``public/index.php`` .
