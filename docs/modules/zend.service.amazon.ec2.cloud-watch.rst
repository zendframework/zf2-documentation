...
``getMetricStatistics()`` only requires two parameters but it also has four additional parameters that are optional.
    ...
    - Required:MeasureName The measure name that corresponds to
    ...
    - more information click hereStatistics The statistics to be returned for the given
    ...
    - more information click hereOptional:Dimensions Amazon CloudWatch allows you to specify one
    ...
    - StartTime The timestamp of the first datapoint to
